...
function staffChatBuildMsg(m) {
    ...
    bubble.style.cssText = 'max-width:70%;display:flex;flex-direction:column;gap:3px;' + (isSelf ? 'align-items:flex-end;' : '');
    ...
    text.style.cssText = 'padding:8px 12px;background:rgba(255,255,255,0.05);border:1px solid var(--border);border-radius:10px;font-size:0.82rem;line-height:1.45;word-break:break-word;';
